...
export default function Class10Page() {
  return (
    <>
      <Breadcrumbs items={[{ label: 'Browse Materials', href: '/browse' }, { label: 'Class 10' }]} />
      <section aria-label="Class 10" className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-24 pt-6">
        <div className="text-center mb-12">
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-ink tracking-tight mb-3">Class 10</h1>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link
            href="/class-10/computer-science"
            ...
            aria-label="Class 10 Computer Science"
          >
            ...
            <p className="text-sm text-stone leading-relaxed mb-4">
              5 chapters from Essentials of Computer Science for Grade 10. Each chapter has detailed
