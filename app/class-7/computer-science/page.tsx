...
export default function SubjectPage() {
  ...
  return (
    <>
      <Breadcrumbs items={[{ label: 'Browse Materials', href: '/browse' }, { label: 'Class 7', href: '/class-7' }, { label: 'Computer Science' }]} />
      <section aria-label="Class 7 Computer Science" className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-24 pt-6">
        <div className="text-center mb-12">
          ...
          <p className="text-stone text-lg max-w-2xl mx-auto">
            Essentials of Computer Science for Grade 7, 21 chapters. Each chapter carries notes with the textbook's figures and tables, plus the exercise question bank with solved answers.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {units.map((unit) => {
            ...
            return (
              <Link
                key={unit.unit_id}
                href={`/class-7/computer-science/${unit.unit_id}`}
