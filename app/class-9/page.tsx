...
export const metadata = {
  title: 'Class 9 — Study Materials | study.companion',
  description: 'Class 9 Computer Science study materials: summaries, key concepts, Q&A and detailed teaching notes.',
};

export default function Class10Page() {
  return (
    <>
      <Breadcrumbs items={[{ label: 'Browse Materials', href: '/browse' }, { label: 'Class 9' }]} />
      <section aria-label="Class 9" className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-24 pt-6">
        <div className="text-center mb-12">
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-ink tracking-tight mb-3">Class 9</h1>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link
            ...
            aria-label="Class 9 Computer Science"
          >
            ...
            <p className="text-sm text-stone leading-relaxed mb-4">
              5 chapters from Essentials of Computer Science for Grade 9. Each chapter has detailed
