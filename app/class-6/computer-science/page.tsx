...
export const metadata = {
  title: 'Class 6 Computer Science — Chapters | study.companion',
  description: 'Class 6 Computer Science chapters with summaries, key concepts, Q&A, exercise solutions and detailed teaching notes with figures.',
};
      ...
      <section aria-label="Class 6 Computer Science" className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-24 pt-6">
        <div className="text-center mb-12">
          ...
          <p className="text-stone text-lg max-w-2xl mx-auto">
            Essentials of Computer Science for Grade 6, 15 chapters. Each chapter carries notes with the textbook's figures and tables, plus the exercise question bank with solved answers.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {units.map((unit) => {
            ...
            return (
              <Link
                key={unit.unit_id}
                href={`/class-6/computer-science/${unit.unit_id}`}
