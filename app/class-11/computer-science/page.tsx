...
export const metadata = {
  title: 'Class 11 Computer Science — Chapters | study.companion',
  description: 'Class 11 Computer Science chapters with summaries, key concepts, Q&A, exercise solutions and detailed teaching notes with figures.',
};
...
export default function SubjectPage() {
  ...
  return (
    <>
      <Breadcrumbs items={[{ label: 'Browse Materials', href: '/browse' }, { label: 'Class 11', href: '/class-11' }, { label: 'Computer Science' }]} />
      <section aria-label="Class 11 Computer Science" className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-24 pt-6">
        <div className="text-center mb-12">
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-ink tracking-tight mb-3">
            Class 11 Computer Science
          </h1>
          <p className="text-stone text-lg max-w-2xl mx-auto">
            Essentials of Computer Science for Grade 11, 8 chapters. Each chapter carries detailed teaching
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {units.map((unit) => {
            ...
            return (
              <Link
                key={unit.unit_id}
                href={`/class-11/computer-science/${unit.unit_id}`}
