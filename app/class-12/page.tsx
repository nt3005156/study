...
export const metadata = {
  title: 'Class 12 — Study Materials | study.companion',
  description: 'Class 12 Computer Science study materials: summaries, key concepts, Q&A and detailed teaching notes.',
};

export default function Class12Page() {
  return (
    <>
      <Breadcrumbs items={[{ label: 'Browse Materials', href: '/browse' }, { label: 'Class 12' }]} />
      <section aria-label="Class 12" className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-24 pt-6">
        <div className="text-center mb-12">
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-ink tracking-tight mb-3">Class 12</h1>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link
            href="/class-12/computer-science"
            ...
            aria-label="Class 12 Computer Science"
          >
            ...
            <p className="text-sm text-stone leading-relaxed mb-4">
              7 chapters. Every chapter has detailed teaching notes with worked figures,
              tables, solved programs and the full Exercise question bank.
            </p>
            <div className="flex flex-wrap gap-2 mb-5">
              <span className="inline-flex items-center gap-1 rounded-full bg-amber/10 px-2.5 py-1 text-xs font-bold text-amber-deep">
                <Sparkles size={12} /> All 7 chapters detailed
              </span>
