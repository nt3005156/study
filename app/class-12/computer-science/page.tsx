...
export const metadata = {
  title: 'Class 12 Computer Science — Chapters | study.companion',
  description: 'Class 12 Computer Science chapters with summaries, key concepts, Q&A, exercise solutions and detailed teaching notes with figures.',
};
...
export default function SubjectPage() {
  ...
  return (
    <>
      <Breadcrumbs items={[{ label: 'Browse Materials', href: '/browse' }, { label: 'Class 12', href: '/class-12' }, { label: 'Computer Science' }]} />
      <section aria-label="Class 12 Computer Science" className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-24 pt-6">
        <div className="text-center mb-12">
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-ink tracking-tight mb-3">
            Class 12 Computer Science
          </h1>
          <p className="text-stone text-lg max-w-2xl mx-auto">
            Computer Science, 7 chapters. Units 1–7 (DBMS, Data Communication and Networking, Web Technology II, Programming in C, OOP,
            Software Process Model and Recent Trends) include full detailed teaching notes with every figure,
            table, lab program and Exercise question bank from the textbook.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {units.map((unit) => {
            ...
            return (
              <Link
                key={unit.unit_id}
                href={`/class-12/computer-science/${unit.unit_id}`}
                ...
                {detailed ? (
                  <>
                    <p className="text-sm text-stone leading-relaxed mb-4">
                      {detailed.chapter_title} — full notes transcribed from the textbook (pages {detailed.book_pages}).
                    </p>
