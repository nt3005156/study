...
export const metadata = {
  title: 'Class 8 Computer Science — Chapters | study.companion',
  description: 'Class 8 Computer Science chapters with summaries, key concepts, Q&A, exercise solutions and detailed teaching notes with figures.',
};
...
export default function SubjectPage() {
  ...
  return (
    <>
      <Breadcrumbs items={[{ label: 'Browse Materials', href: '/browse' }, { label: 'Class 8', href: '/class-8' }, { label: 'Computer Science' }]} />
      <section aria-label="Class 8 Computer Science" className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-24 pt-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {units.map((unit) => {
            ...
            return (
              <Link
                key={unit.unit_id}
                href={`/class-8/computer-science/${unit.unit_id}`}
